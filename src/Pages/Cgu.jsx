import "../Sass/cgu.scss";

function Cgu() {
  return (
    <div className="cgu">
        <h2>Conditions générales d’utilisation du site JMaterial</h2>

        <div><h3>Article 1 : </h3><h4>Objet</h4></div>
        <p>Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site JMaterial (ci-après dénommé « le site »).</p>
        <p>Constituant le contrat entre la société Joker Material, l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces CGU. L’accès à cette plateforme signifie l’acceptation des présentes CGU.</p>

        <div><h3>Article 2 : </h3><h4>Mentions légales</h4></div>
        <p>L’édition du site JMaterial est assurée par la société Joker Material inscrite au RCS sous le numéro 000 000 000, dont le siège social est localisé au 226 Boulevard Voltaire, 75011, Paris, France Métropolitaine.</p>
        <p>L’hébergeur du site JMaterial.fr est la société XXX, sise au XXXXX, France.</p>

        <div><h3>Article 3 : </h3><h4>Accès au site</h4></div>
        <p>Le site JMaterial permet d’accéder gratuitement à la vente fictive de materiel electronique</p>
        ...
        <div><h3>Article 4 : </h3><h4>Collecte des données</h4></div>
        ...
        <div><h3>Article 5 : </h3><h4>Propriété intellectuelle</h4></div>
        <p>Les marques, logos ainsi que les contenus du site JMaterial (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.</p>
        ...
        <div><h3>Article 6 : </h3><h4>Responsabilité</h4></div>
        ...
        <div><h3>Article 7 : </h3><h4>Liens hypertextes</h4></div>
        ...
        <div><h3>Article 8 :</h3><h4>Cookies</h4></div>
        ...
        <p>L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site JMaterial.fr.</p>
        ...
        <div><h3>Article 9 : </h3><h4>Publication par l’Utilisateur</h4></div>
        <p>Le site JMaterial permet aux membres de publier des commentaires.</p>
        ...
        <div><h3>Article 10 : </h3><h4>Durée du contrat</h4></div>
        ...
        <div><h3>Article 11 : </h3><h4> Droit applicable et juridiction compétente</h4></div>
